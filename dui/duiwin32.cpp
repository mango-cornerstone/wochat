...
void XLabel::setText(wchar_t* text, U16 len)
{
    if (len > 0)
    {
        ...
        assert(pTextFactory);
        assert(pTextFormat);
        pTextFactory->CreateTextLayout((const WCHAR*)m_Text, m_TextLen, pTextFormat, (FLOAT)1, (FLOAT)1, (IDWriteTextLayout**)(&m_pTextLayout));
